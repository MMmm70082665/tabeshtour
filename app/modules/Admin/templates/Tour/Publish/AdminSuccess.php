...
.:: در این بخش شما میتوانید تور ها را غیر فعال را مدیریت کنید ::.
</div>
<div class="tab_description">
.:: در صورت کلیک به روی یک رکورد منتشر نشده میتوانید آن را منتشر کنید ::.
</div>
</div>
...
<table cellspacing="0" class="general">
	<thead>
		<tr>
			...
			<a href="<?php echo $ro->gen('admin.tour.publish.pub',array('id' => $post['Id']));?>">غیر فعال </a></td>
