...
<span class="active">شرکت های  غیر فعال </span>
</div>
...
<div class="tab_description">
.:: در صورت کلیک به روی یک رکورد غیر فعال میتوانید آن را در وضعیت فعال قرار دهید ::.
</div>
</div>
...
<table cellspacing="0" class="general">
	<thead>
		<tr>
			...
			<a href="<?php echo $ro->gen('admin.member.publish.pub',array('id' => $member['Id']));?>"> غیر فعال</a></td>
