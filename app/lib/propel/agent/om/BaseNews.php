...
abstract class BaseNews extends BaseObject implements Persistent
{
    ...
    public function setLongDesc($v)
    {
        ...
        if ($this->long_desc !== $v) {
            $this->long_desc = $v;
            $this->modifiedColumns[] = NewsPeer::LONG_DESC;
        }
    ...
    public function setShortDesc($v)
    {
        ...
        if ($this->short_desc !== $v) {
            $this->short_desc = $v;
            $this->modifiedColumns[] = NewsPeer::SHORT_DESC;
        }
    ...
    public function setPublish($v)
    {
        ...
        if ($this->publish !== $v) {
            $this->publish = $v;
            $this->modifiedColumns[] = NewsPeer::PUBLISH;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->publish = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NewsPeer::LONG_DESC)) {
            $modifiedColumns[':p' . $index++]  = '`long_desc`';
        }
        if ($this->isColumnModified(NewsPeer::SHORT_DESC)) {
            $modifiedColumns[':p' . $index++]  = '`short_desc`';
        }
        if ($this->isColumnModified(NewsPeer::PUBLISH)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setPublish($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsPeer::LONG_DESC)) $criteria->add(NewsPeer::LONG_DESC, $this->long_desc);
        if ($this->isColumnModified(NewsPeer::SHORT_DESC)) $criteria->add(NewsPeer::SHORT_DESC, $this->short_desc);
        if ($this->isColumnModified(NewsPeer::PUBLISH)) $criteria->add(NewsPeer::PUBLISH, $this->publish);
