...
abstract class BaseMember extends BaseObject implements Persistent
{
    ...
    public function setOffice($v)
    {
        ...
        if ($this->office !== $v) {
            $this->office = $v;
            $this->modifiedColumns[] = MemberPeer::OFFICE;
        }
    ...
    public function setWebsite($v)
    {
        ...
        if ($this->website !== $v) {
            $this->website = $v;
            $this->modifiedColumns[] = MemberPeer::WEBSITE;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[] = MemberPeer::DATE;
        }
    ...
    public function setPublish($v)
    {
        ...
        if ($this->publish !== $v) {
            $this->publish = $v;
            $this->modifiedColumns[] = MemberPeer::PUBLISH;
        }
    ...
    public function setDesc($v)
    {
        ...
        if ($this->desc !== $v) {
            $this->desc = $v;
            $this->modifiedColumns[] = MemberPeer::DESC;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->office = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 9; // 9 = MemberPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MemberQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MemberPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(MemberPeer::OFFICE)) {
            $modifiedColumns[':p' . $index++]  = '`office`';
        }
        if ($this->isColumnModified(MemberPeer::ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`address`';
        }
        if ($this->isColumnModified(MemberPeer::WEBSITE)) {
            $modifiedColumns[':p' . $index++]  = '`website`';
        }
        if ($this->isColumnModified(MemberPeer::PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`phone`';
        }
        if ($this->isColumnModified(MemberPeer::FAX)) {
            $modifiedColumns[':p' . $index++]  = '`fax`';
        }
        if ($this->isColumnModified(MemberPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(MemberPeer::PUBLISH)) {
            $modifiedColumns[':p' . $index++]  = '`publish`';
        }
        if ($this->isColumnModified(MemberPeer::DESC)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Member'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Member'][$this->getPrimaryKey()] = true;
        $keys = MemberPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getOffice(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setOffice($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MemberPeer::OFFICE)) $criteria->add(MemberPeer::OFFICE, $this->office);
        if ($this->isColumnModified(MemberPeer::ADDRESS)) $criteria->add(MemberPeer::ADDRESS, $this->address);
        if ($this->isColumnModified(MemberPeer::WEBSITE)) $criteria->add(MemberPeer::WEBSITE, $this->website);
        ...
        if ($this->isColumnModified(MemberPeer::DATE)) $criteria->add(MemberPeer::DATE, $this->date);
        if ($this->isColumnModified(MemberPeer::PUBLISH)) $criteria->add(MemberPeer::PUBLISH, $this->publish);
        if ($this->isColumnModified(MemberPeer::DESC)) $criteria->add(MemberPeer::DESC, $this->desc);
    ...
    {
        return (string) $this->exportTo(MemberPeer::DEFAULT_STRING_FORMAT);
    }
