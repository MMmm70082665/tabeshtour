 ...
 * @method PartnersQuery orderByAddress($order = Criteria::ASC) Order by the address column
 * @method PartnersQuery orderByWebsite($order = Criteria::ASC) Order by the website column
 * @method PartnersQuery orderByPhone($order = Criteria::ASC) Order by the phone column
 * @method PartnersQuery orderByFax($order = Criteria::ASC) Order by the fax column
 * @method PartnersQuery orderByDesc($order = Criteria::ASC) Order by the desc column
 *
 * @method PartnersQuery groupById() Group by the id column
 * @method PartnersQuery groupByName() Group by the name column
 * @method PartnersQuery groupByAddress() Group by the address column
 * @method PartnersQuery groupByWebsite() Group by the website column
 * @method PartnersQuery groupByPhone() Group by the phone column
 * @method PartnersQuery groupByFax() Group by the fax column
 * @method PartnersQuery groupByDesc() Group by the desc column
 *
 ...
 *
 * @method Partners findOneByName(string $name) Return the first Partners filtered by the name column
 * @method Partners findOneByAddress(string $address) Return the first Partners filtered by the address column
 * @method Partners findOneByWebsite(string $website) Return the first Partners filtered by the website column
 * @method Partners findOneByPhone(string $phone) Return the first Partners filtered by the phone column
 * @method Partners findOneByFax(string $fax) Return the first Partners filtered by the fax column
 * @method Partners findOneByDesc(string $desc) Return the first Partners filtered by the desc column
 *
 * @method array findById(int $id) Return Partners objects filtered by the id column
 * @method array findByName(string $name) Return Partners objects filtered by the name column
 * @method array findByAddress(string $address) Return Partners objects filtered by the address column
 * @method array findByWebsite(string $website) Return Partners objects filtered by the website column
 * @method array findByPhone(string $phone) Return Partners objects filtered by the phone column
 * @method array findByFax(string $fax) Return Partners objects filtered by the fax column
 * @method array findByDesc(string $desc) Return Partners objects filtered by the desc column
 *
...
abstract class BasePartnersQuery extends ModelCriteria
{
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PartnersPeer::NAME, $name, $comparison);
    }
    ...
    public function filterByAddress($address = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PartnersPeer::ADDRESS, $address, $comparison);
    }
    ...
    public function filterByWebsite($website = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PartnersPeer::WEBSITE, $website, $comparison);
    }
    ...
    public function filterByPhone($phone = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PartnersPeer::PHONE, $phone, $comparison);
    }
    ...
    public function filterByFax($fax = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PartnersPeer::FAX, $fax, $comparison);
    }
    ...
    public function filterByDesc($desc = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PartnersPeer::DESC, $desc, $comparison);
    }
