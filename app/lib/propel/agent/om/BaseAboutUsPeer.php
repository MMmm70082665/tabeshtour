...
/**
 * Base static class for performing query and update operations on the 'about_us' table.
 *
 *
 *
...
abstract class BaseAboutUsPeer
{
     ...
     * e.g. AboutUsPeer::$fieldNames[AboutUsPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', ),
        BasePeer::TYPE_COLNAME => array (AboutUsPeer::ID, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. AboutUsPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, ),
        BasePeer::TYPE_COLNAME => array (AboutUsPeer::ID => 0, ),
    ...
    {
        $toNames = AboutUsPeer::getFieldNames($toType);
        $key = isset(AboutUsPeer::$fieldKeys[$fromType][$name]) ? AboutUsPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(AboutUsPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, AboutUsPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return AboutUsPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AboutUsPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AboutUsPeer::DATABASE_NAME);
     ...
     *
     * @param      AboutUs $obj A AboutUs object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(AboutUsPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(AboutUsPeer::$instances[$key])) {
                return AboutUsPeer::$instances[$key];
            }
        }
    ...
    {
        AboutUsPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to about_us
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = AboutUsPeer::getInstanceFromPool($key))) {
            ...
            $col = $startcol + AboutUsPeer::NUM_HYDRATE_COLUMNS;
        } else {
    ...
    {
        return Propel::getDatabaseMap(AboutUsPeer::DATABASE_NAME)->getTable(AboutUsPeer::TABLE_NAME);
    }
    ...
    {
        return AboutUsPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a AboutUs or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a AboutUs or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(AboutUsPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the about_us table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a AboutUs or Criteria object OR a primary key value.
     *
