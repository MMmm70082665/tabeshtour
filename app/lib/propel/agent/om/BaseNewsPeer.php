...
abstract class BaseNewsPeer
{
    ...
    const LONG_DESC = 'news.long_desc';

    /** the column name for the short_desc field */
    const SHORT_DESC = 'news.short_desc';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Subject', 'LongDesc', 'ShortDesc', 'Publish', 'Date', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'subject', 'longDesc', 'shortDesc', 'publish', 'date', ),
        BasePeer::TYPE_COLNAME => array (NewsPeer::ID, NewsPeer::SUBJECT, NewsPeer::LONG_DESC, NewsPeer::SHORT_DESC, NewsPeer::PUBLISH, NewsPeer::DATE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SUBJECT', 'LONG_DESC', 'SHORT_DESC', 'PUBLISH', 'DATE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'subject', 'long_desc', 'short_desc', 'publish', 'date', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Subject' => 1, 'LongDesc' => 2, 'ShortDesc' => 3, 'Publish' => 4, 'Date' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'subject' => 1, 'longDesc' => 2, 'shortDesc' => 3, 'publish' => 4, 'date' => 5, ),
        BasePeer::TYPE_COLNAME => array (NewsPeer::ID => 0, NewsPeer::SUBJECT => 1, NewsPeer::LONG_DESC => 2, NewsPeer::SHORT_DESC => 3, NewsPeer::PUBLISH => 4, NewsPeer::DATE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SUBJECT' => 1, 'LONG_DESC' => 2, 'SHORT_DESC' => 3, 'PUBLISH' => 4, 'DATE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'subject' => 1, 'long_desc' => 2, 'short_desc' => 3, 'publish' => 4, 'date' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsPeer::LONG_DESC);
            $criteria->addSelectColumn(NewsPeer::SHORT_DESC);
            $criteria->addSelectColumn(NewsPeer::PUBLISH);
